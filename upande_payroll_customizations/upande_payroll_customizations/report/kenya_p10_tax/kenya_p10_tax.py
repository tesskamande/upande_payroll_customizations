...
def get_p10_report_data(filters):
    ...
    component_mappings = {
        ...
        "total_cash_pay": ["Basic salary", "Basic", "Acting Allowance", "Bank Allowance", 
                          "Insurance Prem Allowance", "Special Duty Allowance", "Spray Allowance", 
                          "Torch Allowance", "Uniform Allowance", "Travel", "Transport Allowance", 
                          "Travel Allowance", "Transfer Allowance", "Cash Housing Allowance", 
                          "Leave Pay", "Leave Pay in Lieu", "Overtime", "Bonus", "Arrear", 
                          "Arrears-B+H/A-NT", "Arrears-Leave Travel", "Benevolent Payment", 
                          "Days Worked Next Month", "Gratuity", "Leave Encashment", "Payroll Claim"],
        
        # Non-cash benefits
        "value_of_car_benefit": ["Car Benefit"],
        "value_of_housing": ["Quarters", "Housing"],
        "value_of_meals": ["Meals Allowance", "Meal Benefit"],
        "value_of_other_benefits": ["Electricity and Water Benefit", "Telephone Benefit", 
                                   "Non-cash Benefit", "Non-cash taxable benefit"],
        
        # Deductions
        "mortgage_interest": ["Mortgage Interest"],
        "nssf_contribution": ["NSSF TIER 1", "NSSF TIER2"],
